...
const OnboardingFlow = (props: OnboardingWidgetProps) => {
      ...
      switch (process.env.MEDUSA_ADMIN_ONBOARDING_TYPE) {
        ...
        default:
          return [
            ...
            {
              id: "setup_finished",
              title: "Setup Finished: Start developing with ECM",
  ...
  const getStartedText = () => {
    switch (process.env.MEDUSA_ADMIN_ONBOARDING_TYPE) {
      case "nextjs":
        return "Learn the basics of ECM by creating your first order using the Next.js storefront.";
      default:
        return "Learn the basics of ECM by creating your first order.";
    }
  };
